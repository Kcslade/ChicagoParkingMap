...
class ProjectPoints(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for current, point in enumerate(features):
            ...
            # Determine the direction based on bearing and address parity
            if (315 <= bearing or bearing < 45):  # North
                if address % 2 == 0:
                    new_bearing = bearing + 90  # Even
                else:
                    new_bearing = bearing - 90  # Odd
            ...
            # Ensure the new bearing is within 0-360 degrees
            new_bearing = new_bearing % 360

            # Calculate perpendicular projection
            angle_rad = math.radians(new_bearing)
